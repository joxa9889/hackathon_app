...
class FavouritesSelectionPage extends StatefulWidget {
  const FavouritesSelectionPage({super.key});

  @override
  State<FavouritesSelectionPage> createState() => _FavouritesSelectionPageState();
}

class _FavouritesSelectionPageState extends State<FavouritesSelectionPage> {
      ...
      body: Container(
        ...
        decoration: const BoxDecoration(
          image: DecorationImage(
            image: AssetImage("assets/imgs/favourite_select.jpeg"),
            fit: BoxFit.cover,
          ),
        ),
        child: SafeArea(
